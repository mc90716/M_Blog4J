...
function init(){
var str = '${article.articleType}';
document.getElementById("selType").value = str;
var s = '${article.category.categoryId}';
var selects = document.getElementsByName("category");  
for (var i=0; i<selects.length; i++){  
    if (selects[i].value == s) {  
				...
				<div class="blogmain">
					...
					<div class="tabs_header">
						<ul id="ul_tab" class="tabs">
							<li class="active" id="li_articleManage"><a href="javascript:void(0);"><span>文章编辑</span></a></li>
						</ul>
					</div>


					<div style="display: block;" id="publishManage">
						<form action="articleAction!updateArticle.action?currentPage=1&articleId=<%=article.getArticleId() %>"
							method="post">
							<div id="sel_div" class="h_status">
								...
								<input type="text" name="article.title" class="input_title" value="<%=article.getTitle()%>">
							</div>
							<div style="width: 300px;">
								<textarea name="article.content" id="myEditor"
									style="width: 565px;"><%=article.getContent() %></textarea>
							</div>
							<script type="text/javascript">
