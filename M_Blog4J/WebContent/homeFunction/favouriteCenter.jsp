...
<%
	...
	ArrayList<Article> articles = (ArrayList<Article>)request.getAttribute("favourites");
%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="tail-bottom">
		<div id="main">
			...
			<div class="wrapper indent">
				...
				<!-- bloglist -->
				<div class="favouriteCenter">
					<h1 class="favouriteh1">
						<a class="favourite1" href="#">添加收藏</a>收藏
					</h1>
					<div class="favouriteList">
					
					<% for(Article article : articles) {%>
						<dl class="favourite_dl">

							<dt>
								<span class="fr"> <a href="articleAction!viewArticle.action?id=<%=article.getArticleId() %>" target="_blank">查看</a>
								 <a	href="favouriteAction!deleteFavourite.action?articleId=<%=article.getArticleId()%>">删除</a>
								</span> <span class="time"><%=article.getCreateTime() %></span> <a href="#" class="share">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
								<span> <a target="_blank" href="articleAction!viewArticle.action?id=<%=article.getArticleId() %>" class="article_title"><%=article.getTitle() %></a>
								</span>
							</dt>
						</dl>
					<%} %>
